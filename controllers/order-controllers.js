...
const createOrder= async (req, res, next)=>{
    ...
    const{title, description, creator, amount,ordercreator, price, productcreator, image, time}= req.body;
  
    const a = new Date()
    const b =a.getDate()+"/"+a.toLocaleString('default', { month: 'long' })+"/"+a.getFullYear()
